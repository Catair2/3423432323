...
start "zapret: %~n0" /min "%BIN%winws.exe" --wf-tcp=80,443,2053,2083,2087,2096,8443,8800,%GameFilterTCP% --wf-udp=443,19294-19344,50000-50100,%GameFilterUDP% ^
...
--filter-tcp=8800 --dpi-desync=syndata --dpi-desync-repeats=12 --dpi-desync-any-protocol=1 --dpi-desync-fake-tls="%BIN%tls_epic_games.bin"